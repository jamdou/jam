...
data_list = []
# sgy文件路径
pp_path = r"E:\研究生\line2000\cmp5998652.segy"
...
name22=r"d:\jam\python\cmp5998652_raw.csv"
np.savetxt(name22,data_numpy,delimiter = ',')

name23=r"d:\jam\python\cmp5998652.csv"
np.savetxt(name23,train_restruct,delimiter = ',')